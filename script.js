...
console.log("Edosn".split("").reverse().join(""));
...
// desafio: crie uma função para verifica palidromos e retorne TRUE ou FALSE. A logica deve receber strig com palavras ou texto


// desafio: crie uma logica que verifique quantos dias faltam para o ano novo 01/01/2025
...
console.log(verificaPalindromo("ano"));
...
const daytoNewYear = newYear - today 

console.log(Math.floor (daytoNewYear / 1000 / 60 / 24));
